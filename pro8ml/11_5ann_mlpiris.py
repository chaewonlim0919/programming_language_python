'''ex55
인공신경망(Artificial Neural Network) - MLP(다층 퍼셉트론, Multilayer Perceptron)
    iris dataset 사용
'''
import pandas as pd
import numpy as np
...
joblib.dump(model, 'MLPmodel.pkl') # 확장자명은 sav, model... 이 3개가 일반적으로 많이 사용
del model

# 읽기
read_model = joblib.load('MLPmodel.pkl')
